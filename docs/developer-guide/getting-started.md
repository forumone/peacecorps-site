...
- Each developer works off a `fork` of the main [Threespot Repository](https://github.com/Threespot/peacecorps-site). These forks are located in their personal GitHub accounts. For instance, here is [Sean Herron's](https://github.com/seanherron/peacecorps-site) and [CM Lubinski's](https://github.com/cmc333333/peacecorps-site).
